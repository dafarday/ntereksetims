...
using ntereksetims.Activation;
using ntereksetims.Contracts.Services;
using ntereksetims.Core.Contracts.Services;
using ntereksetims.Core.Services;
using ntereksetims.Helpers;
using ntereksetims.Models;
using ntereksetims.Notifications;
using ntereksetims.Services;
using ntereksetims.ViewModels;
using ntereksetims.Views;

namespace ntereksetims;
...
public partial class App : Application
{
    ...
    public App()
    {
        ...
        ConfigureServices((context, services) =>
        {
            ...
            services.AddTransient<StockManagementPage>();
